...
var n, config = {
  ...
  a = function () {
    var e = {};
    for (var n in config) e[config[n]] = n;
    return e
  }(),
  i = win.document,
  t = i.title,
...
var I = !1,
  ...
  wx = {
    config: function (e) {
          ...
          return t.push(function () {
            ! function () {
              if (!(d || u || v.debug || m < "6.0.2" || h.systemType < 0)) {
                var i = new Image;
                h.appId = v.appId, h.initTime = g.initEndTime - g.initStartTime, h.preVerifyTime = g.preVerifyEndTime - g.preVerifyStartTime, wx.getNetworkType({
                  isInnerInvoke: !0,
                  success: function (e) {
      ...
      }), wx.invoke || (wx.invoke = function (e, n, i) {
        win.WeixinJSBridge && WeixinJSBridge.invoke(e, x(n), i)
      }, wx.on = function (e, n) {
        win.WeixinJSBridge && WeixinJSBridge.on(e, n)
      })
    },
    ready: function (e) {
    ...
    onMenuShareAppMessage: function (n) {
      P(config.onMenuShareAppMessage, {
        complete: function (e) {
    ...
    openAddress: function (e) {
      M(config.openAddress, {}, (e._complete = function (e) {
        e = function (e) {
    ...
    openProductSpecificView: function (e) {
      M(config.openProductSpecificView, {
        pid: e.productId,
    ...
    consumeAndShareCard: function (e) {
      M(config.consumeAndShareCard, {
        consumedCardId: e.cardId,
        consumedCode: e.code
      }, e)
    },
    chooseWXPay: function (e) {
      M(config.chooseWXPay, V(e), e)
    },
    openEnterpriseRedPacket: function (e) {
      M(config.openEnterpriseRedPacket, V(e), e)
    },
    startSearchBeacons: function (e) {
      M(config.startSearchBeacons, {
        ticket: e.ticket
      }, e)
    },
    stopSearchBeacons: function (e) {
      M(config.stopSearchBeacons, {}, e)
    },
    onSearchBeacons: function (e) {
      P(config.onSearchBeacons, e)
    },
    ...
    miniProgram: {
      ...
      getEnv: function (e) {
        O(function () {
          e({
            miniprogram: "miniprogram" === win.__wxjs_environment
          })
        })
      }
    }
...
function M(n, e, i) {
  win.WeixinJSBridge ? WeixinJSBridge.invoke(n, x(e), function (e) {
    A(n, e, i)
  }) : B(n, i)
}

function P(n, i, t) {
  win.WeixinJSBridge ? WeixinJSBridge.on(n, function (e) {
...
function O(e) {
  l && (win.WeixinJSBridge ? e() : i.addEventListener && i.addEventListener("WeixinJSBridgeReady", e, !1))
}